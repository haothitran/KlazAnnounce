...
spellframe:SetJustifyH(C.Font.Justify)
spellframe:SetMaxLines(C.Size.Lines)
spellframe:SetTimeVisible(C.Font.Visible)
spellframe:SetFadeDuration(C.Font.Fade)
